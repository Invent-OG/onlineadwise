...
const TestimonialHome = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-white py-20 px-6 md:px-16">
      <h2 className="text-4xl md:text-5xl font-bold text-center text-black mb-16">
        What Our Clients Say
      </h2>
      ...
      >
        ...
        {testimonials.concat(testimonials).map((testimonial, idx) => (
          <div
            key={idx}
            className="bg-white p-6 md:p-8 rounded-2xl shadow-lg min-w-[300px] max-w-[350px] flex flex-col justify-between transform transition-transform duration-300 hover:scale-105 border border-gray-200"
          >
            {/* Reviewer Info */}
            <div className="flex justify-between items-center mb-4">
              <div className="flex flex-col">
