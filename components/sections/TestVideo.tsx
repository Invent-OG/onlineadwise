...
//     // Split Text for Make Section (lines only for smooth reveal)
...
//     // === Make Section Text Animation (new mask reveal effect) ===
...
//     // === Gallery Animation (keep parallax zoom + tilt) ===
//     gsap.utils.toArray<HTMLImageElement>(".gallery-item img").forEach((img, i) => {
//       gsap.fromTo(
//         img,
//         {
//           scale: 1.2,
...
//             {/* Smaller, aligned text */}
//             <div className="make-main text-center md:text-left grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl">
//               <div
//                 className="make-text text-2xl md:text-5xl font-semibold leading-tight up-text"
//                 split-lines
//               >
//                 <span className="text-yellow-500">Relaxation</span> <br />
//                 and pampering
//               </div>
//               <div
//                 className="make-text text-2xl md:text-5xl font-semibold leading-tight up-text"
...
//               <div className="gallery-wrapp relative w-full md:flex-1 h-64 md:h-full rounded-md overflow-hidden">
//                 <div className="gallery-main w-full h-full">
//                   <div className="gallery-item relative w-full h-full overflow-hidden rounded-md">
//                     <img
