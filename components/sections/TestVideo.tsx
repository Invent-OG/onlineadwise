...
//             <div className="make-subtitle text-white font-medium uppercase mb-6">
//               we make
//             </div>

//             <div className="make-main grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-6xl">
//               <div
//                 className="make-text text-4xl md:text-6xl font-bold up-text"
//                 split-lines
//               >
//                 Mobile <br /> boots for those
//               </div>
//               <div
//                 className="make-text text-4xl md:text-6xl font-bold up-text"
//                 split-lines
//               >
//                 who have spent time through war
//               </div>
//             </div>

//             <div className="make-gallery relative flex flex-row justify-between items-center w-full max-w-6xl mt-10 gap-4 h-[50vh] md:h-[80vh]">
//               <div className="gallery-wrapp relative flex-1 h-full rounded-md overflow-hidden">
