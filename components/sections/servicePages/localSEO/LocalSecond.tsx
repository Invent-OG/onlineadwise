...
import { Calendar, ArrowRight, Globe, Users, MapPin } from "lucide-react";
import { Button } from "@/components/ui/button";

gsap.registerPlugin(ScrollTrigger);

export default function LocalSecond() {
        ...
        <div className="flex flex-col justify-start space-y-4">
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Attract clients in your community by improving your presence in
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Optimize your Google Business Profile, local citations, and review
              management to stand out to nearby clients.
            </p>
          </div>
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Implement a data-driven local SEO strategy to drive consultations,
              increase case volume, and connect with clients actively seeking
              legal services.
            </p>
          </div>
        </div>
