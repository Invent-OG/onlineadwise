...
import { Calendar, ArrowRight, BarChart2, PieChart, Activity } from "lucide-react";
import { Button } from "@/components/ui/button";

gsap.registerPlugin(ScrollTrigger);

export default function AnalyticsSecond() {
        ...
        <div className="flex flex-col justify-start space-y-4">
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              At OnlineADwise Marketing, we provide analytics solutions for law
              firms to track, measure, and optimize marketing performance,
              helping you identify high-performing campaigns and drive client
              acquisition.
            </p>
          </div>
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              With over 10 years in legal digital marketing, we focus on the
              metrics that matter most. From website traffic to ROI reports, our
              analytics give you clear insights to measure and improve
              performance.
            </p>
          </div>
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Partner with OnlineADwise to leverage data-driven insights that
              inform your strategy, optimize your campaigns, and maximize
              results. Our analytics solutions empower your firm to make
              informed decisions, improve client acquisition, and achieve
              sustainable growth.
            </p>
          </div>
        </div>
