...
import { Calendar, ArrowRight, TrendingUp, Monitor, DollarSign } from "lucide-react";
import { Button } from "@/components/ui/button";

gsap.registerPlugin(ScrollTrigger);

export default function PaidSecond() {
        ...
        <div className="flex flex-col justify-start space-y-4">
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              At OnlineADwise Marketing, we create paid campaigns for law firms
              that attract high-intent leads, maximize ad spend, and convert
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              From Google Ads and social media campaigns to retargeting and
              conversion optimization, we ensure your ads reach the right
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Partner with OnlineADwise to leverage a data-driven, ROI-focused
              approach that grows your practice, increases leads, and drives
              case volume effectively.
            </p>
          </div>
        </div>
