...
//         className="relative z-10 text-center  text-3xl sm:text-4xl md:text-8xl font-extrabold -mt-[18rem] tracking-wide text-white"
//       >
//         FOR BUSINESSES
//       </motion.h2>
...
//         className="relative z-10 text-center text-base font-semibold sm:text-lg md:text-2xl tracking-[0.2em] sm:tracking-[0.3em] text-gray-300 mt-4 sm:mt-6 mb-8 sm:mb-10"
//       >
...
// export default function GbpHero() {
//   return (
//     <section className="relative min-h-screen flex flex-col items-center justify-center  text-white overflow-hidden px-4 md:px-0">
//       {/* 🔹 Background Image */}
...
//         <div className="absolute inset-0 bg-gradient-to-b from-black/10 via-black/90 to-black/90" />
//       </div>
...
//               <stop offset="0" stopColor="#FACC14" stopOpacity="0.6" />
//               <stop offset="0.25" stopColor="transparent" />
//               <stop offset="0.75" stopColor="transparent" />
//               <stop offset="1" stopColor="#FACC14" stopOpacity="0.6" />
//             </linearGradient>
//           </defs>
    ...
    <section className="relative min-h-[60vh] md:min-h-screen flex flex-col items-center justify-center text-white overflow-hidden px-4 md:px-0">
      ...
      >
        ...
        <text
          ...
          textAnchor="middle"
          dominantBaseline="middle"
          fontSize="clamp(24rem, 20vw, 28rem)" // ✅ bigger minimum for mobile
          fontWeight="800"
          fill="transparent"
          stroke="#facc14"
          strokeWidth="2.5"
