...
import { Calendar, ArrowRight, Star, Briefcase, Palette } from "lucide-react";
import { Button } from "@/components/ui/button";

gsap.registerPlugin(ScrollTrigger);

export default function BrandingSecond() {
        ...
        <div className="flex flex-col justify-start space-y-4">
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              At OnlineADwise Marketing, we offer comprehensive branding support
              for law firms, helping you create a strong and consistent
              professional image. Our strategies ensure your firm stands out,
              builds trust with clients, and reinforces your reputation in the
              legal industry.
            </p>
          </div>
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              With over 10 years of experience in legal digital marketing, we
              understand the importance of cohesive branding. From logo and
              visual identity design to messaging, tone, and brand guidelines,
              we ensure your firm communicates professionalism and expertise at
              every touchpoint.
            </p>
          </div>
        </div>

        {/* Right Form - Keep your existing form */}
