...
import { Calendar, ArrowRight, TrendingUp, Edit, Users } from "lucide-react";
        ...
        <div className="flex flex-col justify-start space-y-4">
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              At OnlineADwise, we create a data-driven social media strategy for
              law firms, ensuring your brand reaches the right audience on
              platforms like Facebook, Instagram, LinkedIn, and X.
            </p>
          </div>
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              We develop high-quality, engaging content tailored to your ideal
              clients. From posts, carousels, and stories to videos and blog
              snippets, every piece of content is designed to educate, inspire
              trust, and increase client engagement.
            </p>
          </div>
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Partner with OnlineADwise to grow your practice through social
              media. We use targeted ads, retargeting, and analytics to attract
              high-quality leads, nurture potential clients, and convert them
              into consultations.
            </p>
          </div>
        </div>
