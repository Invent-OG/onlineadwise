...
import { Calendar, ArrowRight, Mail, MessageCircle, Zap } from "lucide-react";
import { Button } from "@/components/ui/button";

gsap.registerPlugin(ScrollTrigger);

export default function CrmSecond() {
        ...
        <div className="flex flex-col justify-start space-y-4">
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              We create targeted email campaigns that nurture leads, engage
              clients, and drive consultations and case sign-ups. Our emails are
              optimized for high open and click-through rates, ensuring your
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Send timely SMS messages, reminders, and promotional updates to
              strengthen client engagement and retention. Our SMS campaigns are
              personalized and compliant, helping you maintain professionalism
              while driving action from your prospects.
            </p>
          </div>
          ...
          <div className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Implement data-driven campaigns that keep your firm top-of-mind
              and drive measurable results efficiently.
            </p>
          </div>
        </div>
